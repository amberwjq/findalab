...
(function($) {
  ...
  $.fn.extend({
    ...
    findalab: function(settings) {
      ...
      this.mapMarker  = {
          path: 'M5.59,0A5.59,5.59,0,0,0,3.951,10.935l1.7,1.7,1.769-1.77A5.588,5.588,0,0,0,5.59,0ZM7.861,8.641A1.013,1.013,0,0,1,7,9.132H4.185A1.01,1.01,0,0,1,3.3,7.646L4.569,5.262V3.2H4.25a.4.4,0,0,1,0-.8H6.92a.4.4,0,1,1,0,.8H6.612v2.06L7.886,7.646A1.014,1.014,0,0,1,7.861,8.641ZM6.344,6.164H4.837a.19.19,0,0,0-.168.1L3.779,7.93a.461.461,0,0,0,.406.678H7A.461.461,0,0,0,7.4,7.93L6.512,6.265A.192.192,0,0,0,6.344,6.164Z',
      ...
      this._constructDayOfWeekFilter = function (dayOfWeekObject) {
        ...
        container.append('<label class = "dayFilter" for="dow-all">'+'<input type="radio" name="day-of-week-filter" id="dow-all" value="" checked>'
